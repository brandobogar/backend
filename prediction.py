...
def prediction(citra_tes, data_tes):
    ...
    model_load = tf.keras.models.load_model('../src/Assets/model/model.h5')
    model_load.compile(
        optimizer='adam',
    ...
    path = '../src/Assets/images/result'
    os.chdir(path)

    if os.path.exists('../src/Assets/images/result/Hasil_Akhir.jpg'):
        os.remove('../src/Assets/images/result/Hasil_Akhir.jpg')
    result = cv.imwrite('Hasil_Akhir.jpg', res)
